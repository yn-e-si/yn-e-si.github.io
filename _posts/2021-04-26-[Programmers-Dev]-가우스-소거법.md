...
> 1. $E1$ 의 $x1$ 의 계수를 1 로 만들고 밑에 있는 변수들을 제거하는 것이 1차목표
>
...
> 2. E2$ 의 $x2$ 의 계수를 1 로 만들고 밑에 있는 변수들을 제거하는 것이 2차 목표
>
...
> 4. 다음으로 $E3$ 의 $x3$ 의 계수를 1로 만드는 것이 3차 목표
>
